...
set(3_13_9${suffix} "https://github.com/dirkarnez/python-portable/releases/download/v3.13.9/python-3.13.9-amd64-portable.zip")
...
function(setup_python version)
	...
	else if("${version}" STREQUAL "3.13.9")
        message("setting up python 3.13.9")
        set(download_url "${3_13_9${suffix}}")
	else()
