function(input RETURN_VARIABLE)
	...
	math(EXPR TEMP_LENGTH "${TEMP_LENGTH} - 2" OUTPUT_FORMAT DECIMAL)
	string(SUBSTRING ${TEMP} 1 ${TEMP_LENGTH} TEMP)
...
function(get_filename_from_url URL RETURN_VARIABLE)
    ...
    string(FIND ${FILE_NAME_WITH_EXTENSION_TO_SAVE} "?" INDEX)
    string(SUBSTRING ${FILE_NAME_WITH_EXTENSION_TO_SAVE} 0 ${INDEX} FILE_NAME_WITH_EXTENSION_TO_SAVE)
